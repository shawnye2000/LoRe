...
def run_ppo(
    ...
    # print(f'reward_model_type:{finetuning_args.reward_model_type}')
    if finetuning_args.reward_model_type != 'agents':
        finetuning_args.reward_model_type = 'agents'
    # print(f'reward_model_type:{finetuning_args.reward_model_type}')
    ref_model = create_ref_model(model_args, finetuning_args, add_valuehead=True)
    reward_model = None #create_reward_model(model, model_args, finetuning_args)
